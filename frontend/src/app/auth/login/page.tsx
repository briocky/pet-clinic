...
export default function Login() {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        loginUser({
            ...
            dispatch(loginRedux(userDetails));
            if (userDetails.systemRole === 'USER') {
        ...
        <section className="h-screen">
            <div className="container h-full px-6 pt-5">
                <div className="flex">
                    ...
                    <Image className="absolute right-40 -z-10" width={200} height={200}
                           src={'/images/dog.png'} alt={'dog'}/>
                </div>

                <div
                    className="g-6 flex pt-10 flex-wrap items-center justify-center lg:justify-between">
                    ...
                    <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
                        <form onSubmit={handleSubmit}>
                            ...
                            {/* <!-- Divider --> */}
                            <div
                                className="my-4 flex items-center before:flex-1 before:border-t before:border-neutral-400 after:flex-1 after:border-t after:border-neutral-400">
